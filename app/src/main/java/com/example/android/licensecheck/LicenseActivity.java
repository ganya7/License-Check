...
public class LicenseActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Log.v("Device Id", deviceId);  //AN EXAMPLE OF LOGGING THAT YOU SHOULD BE DOING :)
        ...
        Button checkLic = (Button) findViewById(R.id.check_license_button);
        checkLic.setOnClickListener(new View.OnClickListener() {
            @Override
